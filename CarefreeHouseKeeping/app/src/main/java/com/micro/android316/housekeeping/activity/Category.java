...
import com.micro.android316.housekeeping.CustomControls.SwitchView;
            ...
            public void onClick(View v) {
                switch (v.getId()){
                    case R.id.old://左边
                        ...
                        switch (point){
                            case 1:
                                intent=new Intent(Category.this,Elderly.class);
                                intent.putExtra("name","老人护理");
